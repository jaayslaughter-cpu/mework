...
LEAGUE_RATES = {
    "K":   0.222,   # FG 2025: 22.2%
    "BB":  0.084,   # FG 2025: 8.4%
    "HBP": 0.011,
    "HR":  0.031,   # 2025: ~1.20 HR/game ÷ 38.5 PA
    "3B":  0.004,
    "2B":  0.047,
    "1B":  0.143,
    "OUT": 0.458,   # adjusted to sum = 1.0
}
...
LEAGUE_WOBA = 0.313   # FG 2025 actual (Baseball Reference / FanGraphs)
