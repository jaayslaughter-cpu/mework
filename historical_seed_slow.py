...
SEASONS  = [2022, 2025, 2024, 2023]   # priority: newest first; 2023 is lowest priority (skip if DB full)
...
def main():
    ...
    for season in SEASONS:
        ...
        if season == 2023:
            ...
            if _db_mb >= 700:
                log.warning("DB at %.0f MB — skipping 2023 seed to preserve headroom (limit 800 MB)", _db_mb)
                continue
